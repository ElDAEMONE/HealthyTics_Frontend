...
class GraphView extends StatefulWidget {
  ...
  dynamic label1, label2, label3, label4, label5;
  ...
  _GraphViewState createState() => _GraphViewState(
      ...
      chartData5: (this.chartData5 != null) ? this.chartData5 : [],
      label1: this.label1,
      label2: this.label2,
      label3: this.label3,
      label4: this.label4,
